...
void gpioConfig()
{
	...
	//potansiyometre
	GPIOInitStructure.GPIO_Mode = GPIO_Mode_AIN;//input
...
void adcConfig()
{
	...
	ADCInitStructure.ADC_ContinuousConvMode=ENABLE;//sürekli okumasi saglandi
	ADCInitStructure.ADC_DataAlign=ADC_DataAlign_Right;//saga yaslanmasi istenmis
